...
var Particles = (function (window, document) {
  ...
  /*  Plugin.prototype._toLocal = function () {
     var _ = this,
       storage = _.storage;
       localStorage.setItem('particulasFinal', JSON.stringify(storage))
     return storage
   } */
...
/**
  ...
  Plugin.prototype.flag = function () {
    var _ = this,
    storage = _.storage;
   /*  _.options.speed = 2 */
  ...
  Plugin.prototype._initializeStorage = function () {
    ...
    lasDeLocal = JSON.parse(localStorage.getItem('particulasFinal'))
    if (lasDeLocal != null && lasDeLocal != false) {
      flagLocal = true
      
      for (const key in _.storage) {

        if (Object.hasOwnProperty.call(_.storage, key)) {
          _.storage[key]['radius'] = lasDeLocal[key]['radius']
          _.storage[key]['vx'] = lasDeLocal[key]['vx']
          _.storage[key]['vy'] = lasDeLocal[key]['vy']
          _.storage[key]['x'] = lasDeLocal[key]['x']
          _.storage[key]['y'] = lasDeLocal[key]['y']
        }

      }
      localStorage.removeItem('particulasFinal')
      /*  */
